...
print(colnames(Questionaries_t))
...
cols_to_convert <- c(
  ...
  "Before the quiz - did you think that you understood how they did it?",
...
str(Questionaries_t[cols_to_convert])

dim(Questionaries_t_clean)
```
